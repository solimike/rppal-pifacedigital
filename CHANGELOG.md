...
- Enable dependabot scanning of Cargo and GitHub Action dependencies. (#12) ([4bb39ed](https://github.com/solimike/rppal-pifacedigital/commit/4bb39ed97393733498890c03b6c1faefe9ab47de))

- Bump actions&#x2F;checkout from 3 to 4 (#13) ([28c4262](https://github.com/solimike/rppal-pifacedigital/commit/28c42623d9ecf47e39a5210521db2b9b4c978f6c))
...
- Support __release-plz__ for generating release PRs. (#15) ([267ec12](https://github.com/solimike/rppal-pifacedigital/commit/267ec12d0e542f11820d8a635a4281028f7e689b))

  Does not invoke the `cargo publish` step for now.

- Bump thiserror from 1.0.63 to 1.0.65 (#23) ([cde5643](https://github.com/solimike/rppal-pifacedigital/commit/cde56434700a8b84259ee100fae9c84b3ac4642b))

- Bump anyhow from 1.0.86 to 1.0.91 (#24) ([3d452f4](https://github.com/solimike/rppal-pifacedigital/commit/3d452f41f7bf379773127b050483638ea6d37147))

- Bump thiserror from 1.0.65 to 1.0.68 (#26) ([3d6ec45](https://github.com/solimike/rppal-pifacedigital/commit/3d6ec45b064d6d2403162ed347304adb94cb5a01))

- Bump anyhow from 1.0.91 to 1.0.93 (#27) ([4c3d5a3](https://github.com/solimike/rppal-pifacedigital/commit/4c3d5a3730f5445d0bd57c643ebe26f3d5f8cb76))

- Bump thiserror from 1.0.68 to 2.0.3 (#28) ([da6ad1c](https://github.com/solimike/rppal-pifacedigital/commit/da6ad1c9f0c7c56823ac77f83a6d9b30b1e28232))

- Bump rppal from 0.19.0 to 0.22.1 (#33) ([3a78eac](https://github.com/solimike/rppal-pifacedigital/commit/3a78eacc2c8807bb119ee18747f0861b0aefb2fc)), Signed-off-by:dependabot[bot] <support@github.com>, Co-authored-by:dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>
...
- Bump anyhow from 1.0.93 to 1.0.94 (#30) ([b502197](https://github.com/solimike/rppal-pifacedigital/commit/b502197cb8293f7ce0d98504674d47efdc4db589)), Signed-off-by:dependabot[bot] <support@github.com>, Co-authored-by:dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>
...
- Bump thiserror from 2.0.3 to 2.0.7 (#32) ([416f485](https://github.com/solimike/rppal-pifacedigital/commit/416f48537637f44584d70299c6b2f9c7578322bd)), Signed-off-by:dependabot[bot] <support@github.com>, Co-authored-by:dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>
...
- Bump env_logger from 0.11.5 to 0.11.6 (#36) ([fc3747c](https://github.com/solimike/rppal-pifacedigital/commit/fc3747c55dcdd84dcbbe7ecaebef44ba3ff64306))

- Bump thiserror from 2.0.7 to 2.0.11 (#37) ([42ef00e](https://github.com/solimike/rppal-pifacedigital/commit/42ef00ee57c90f0b600c883908f605e2de1443ea))

- Bump anyhow from 1.0.94 to 1.0.95 (#34) ([bece278](https://github.com/solimike/rppal-pifacedigital/commit/bece2782d9bfa0489ae2876abb1e4ee54985c0d7))

- Bump log from 0.4.22 to 0.4.25 (#38) ([d41bed8](https://github.com/solimike/rppal-pifacedigital/commit/d41bed8458061a980b1f044260a4f378db1778d4)), Signed-off-by:dependabot[bot] <support@github.com>, Co-authored-by:dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>
...
- Bump log from 0.4.25 to 0.4.26 (#39) ([9fd6abb](https://github.com/solimike/rppal-pifacedigital/commit/9fd6abbf2cd1023be1242feebd8b3342258017a6))

- Bump anyhow from 1.0.95 to 1.0.96 (#40) ([9507fc3](https://github.com/solimike/rppal-pifacedigital/commit/9507fc39fd502ae087066bef8dbf9157482e4616))

- Update to Rust 2024 Edition (#41) ([67d580f](https://github.com/solimike/rppal-pifacedigital/commit/67d580f83a766b10d6301a02d1aa277d6d36932d))
...
- More idiomatic patching of the MCP23S17 dependency. (#11) ([e9a7157](https://github.com/solimike/rppal-pifacedigital/commit/e9a7157110b3d16522f3364ff8c983752a5aef9d))
